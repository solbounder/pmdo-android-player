...
foreach ($expected in @("package: name='io.github.solbounder.pmdoandroid' versionCode='11' versionName='0.1.10'", "sdkVersion:'33'", "targetSdkVersion:'36'", "native-code: 'arm64-v8a'")) {
