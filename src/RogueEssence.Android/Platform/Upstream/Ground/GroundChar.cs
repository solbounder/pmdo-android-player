...
namespace RogueEssence.Ground
{
    ...
    public class GroundChar : GroundAIUser, ICharSprite, IBox, IEntityWithLuaData
    {
        ...
        public override void DrawDebug(SpriteBatch spriteBatch, Loc offset)
        {
            ...
            if (leftHand == center)
                centerColor = new Color(255, (int)centerColor.G, (int)centerColor.B, (int)centerColor.A);
            else
                drawCross(spriteBatch, leftHand - offset, Color.Red);
            if (rightHand == center)
                centerColor = new Color((int)centerColor.R, (int)centerColor.G, 255, (int)centerColor.A);
            else
